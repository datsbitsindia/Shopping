...
// 			$tempRow['final_total'] = ceil($total-$discounted_amount);
	...
	// data of 'appointment' table goes here
	if(isset($_GET['table']) && $_GET['table'] == 'appointment'){
		...
		if(isset($_GET['search'])){
			$search = $_GET['search'];
			$where = " Where `id` like '%".$search."%' OR `persone_name` like '%".$search."%'";
		}
		
		$sql = "SELECT COUNT(*) as total FROM `doctor_appointment` ".$where;
		$db->sql($sql);
		$res = $db->getResult();
		foreach($res as $row)
			$total = $row['total'];
		
		$sql = "SELECT * FROM `doctor_appointment` ".$where." ORDER BY ".$sort." ".$order." LIMIT ".$offset.", ".$limit;
		$db->sql($sql);
		$res = $db->getResult();
		...
		foreach($res as $row){
			...
			$operate = ' <a class="btn-xs btn-danger" href="delete-appointment.php?id='.$row['id'].'"><i class="fa fa-trash-o"></i>Delete</a><a href="appoiment-detail.php?id='.$row['id'].'" class="ml-1"><i class="fa fa-eye"></i> View</a>';
			
			$tempRow['id'] = $row['id'];
			$tempRow['name'] = $row['person_name'];
			$tempRow['email'] = $row['email'];
			$tempRow['mobile_no'] = $row['mobile_no'];
			$tempRow['operate'] = $operate;
			$rows[] = $tempRow;
		}
		$bulkData['rows'] = $rows;
...
// 		print_r($res);
	...
	if(isset($_GET['table']) && $_GET['table'] == 'doctors_mst'){
		...
		$sql = "SELECT COUNT(*) as total FROM `doctors_mst` ".$where;
		$db->sql($sql);
		$res = $db->getResult();
		foreach($res as $row)
			$total = $row['total'];
		
		$sql = "SELECT * FROM `doctors_mst` ".$where." ORDER BY ".$sort." ".$order." LIMIT ".$offset.", ".$limit;
		$db->sql($sql);
		$res = $db->getResult();
		...
		foreach($res as $row){
			$operate = " <a class='btn btn-xs btn-danger delete-doctor' data-id='".$row['id']."' title='Delete'><i class='fa fa-trash-o'></i>Delete</a>";
			
			
			$tempRow['id'] = $row['id'];
			$tempRow['name'] = $row['name'];
			$tempRow['phone_no'] = $row['phone_no'];
	...
	if(isset($_GET['table']) && $_GET['table'] == 'pet_category'){
		...
		$sql = "SELECT COUNT(*) as total FROM `pet_category` ".$where;
		$db->sql($sql);
		$res = $db->getResult();
		foreach($res as $row)
			$total = $row['total'];
		
		$sql = "SELECT * FROM `pet_category` ".$where." ORDER BY ".$sort." ".$order." LIMIT ".$offset.", ".$limit;
		$db->sql($sql);
		$res = $db->getResult();
		...
		foreach($res as $row){
			$operate = " <a class='btn btn-xs btn-danger delete-petcategory' data-id='".$row['id']."' title='Delete'><i class='fa fa-trash-o'></i>Delete</a>";
	...
	if(isset($_GET['table']) && $_GET['table'] == 'slider_category1'){
		...
		$sql = "SELECT COUNT(*) as total FROM `slider_category1` ".$where;
		$db->sql($sql);
		$res = $db->getResult();
		foreach($res as $row)
			$total = $row['total'];
		
		$sql = "SELECT * FROM `slider_category1` ".$where." ORDER BY ".$sort." ".$order." LIMIT ".$offset.", ".$limit;
		$db->sql($sql);
		$res = $db->getResult();
		...
		foreach($res as $row){
			$operate = " <a class='btn btn-xs btn-danger delete-slider-category1' data-id='".$row['id']."' data-image='".$row['image']."' title='Delete'><i class='fa fa-trash-o'></i>Delete</a>";
	...
	if(isset($_GET['table']) && $_GET['table'] == 'slider_category2'){
		...
		$sql = "SELECT COUNT(*) as total FROM `slider_category2` ".$where;
		$db->sql($sql);
		$res = $db->getResult();
		foreach($res as $row)
			$total = $row['total'];
		
		$sql = "SELECT * FROM `slider_category2` ".$where." ORDER BY ".$sort." ".$order." LIMIT ".$offset.", ".$limit;
		$db->sql($sql);
		$res = $db->getResult();
		...
		foreach($res as $row){
			$operate = " <a class='btn btn-xs btn-danger delete-slider-category2' data-id='".$row['id']."' data-image='".$row['image']."' title='Delete'><i class='fa fa-trash-o'></i>Delete</a>";
	...
	if(isset($_GET['table']) && $_GET['table'] == 'slider_category3'){
		...
		$sql = "SELECT COUNT(*) as total FROM `slider_category3` ".$where;
		$db->sql($sql);
		$res = $db->getResult();
		foreach($res as $row)
			$total = $row['total'];
		
		$sql = "SELECT * FROM `slider_category3` ".$where." ORDER BY ".$sort." ".$order." LIMIT ".$offset.", ".$limit;
		$db->sql($sql);
		$res = $db->getResult();
		...
		foreach($res as $row){
			$operate = " <a class='btn btn-xs btn-danger delete-slider-category3' data-id='".$row['id']."' data-image='".$row['image']."' title='Delete'><i class='fa fa-trash-o'></i>Delete</a>";
	...
	if(isset($_GET['table']) && $_GET['table'] == 'slider_category4'){
		...
		$sql = "SELECT COUNT(*) as total FROM `slider_category4` ".$where;
		$db->sql($sql);
		$res = $db->getResult();
		foreach($res as $row)
			$total = $row['total'];
		
		$sql = "SELECT * FROM `slider_category4` ".$where." ORDER BY ".$sort." ".$order." LIMIT ".$offset.", ".$limit;
		$db->sql($sql);
		$res = $db->getResult();
		...
		foreach($res as $row){
			$operate = " <a class='btn btn-xs btn-danger delete-slider-category4' data-id='".$row['id']."' data-image='".$row['image']."' title='Delete'><i class='fa fa-trash-o'></i>Delete</a>";
